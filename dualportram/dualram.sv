////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//  File name             :  dualram.sv
//
//  Port names            :  Inputs : i_dina,i_dinb,i_addra,i_addrb,i_clka,i_clkb,i_ena,i_enb,i_wea,i_web           //
//                           Outputs: o_douta,o_doutb                                                               //
//
//  Description           :
//
//
...
module dualram #(parameter READ_LATENCY = 2,
	...
	always@(posedge i_clka) begin
		if(i_ena) begin
			if (i_wea) begin
				...
				if(!(error_sig[WRITE_LATENCY-1])) begin   //when addresses of port A and port B are not equal
